/*
 * XIAO ESP32-C6 블링크 테스트
 * 목적: 보드 정상 작동, USB 연결, Arduino 환경 테스트
 *
 * XIAO ESP32-C6 내장 LED: GPIO 15
 * 테스트 기준:
 * - Arduino IDE/CLI에서 정상 업로드
 * - 시리얼 모니터(115200 baud)에 "LED ON/OFF" 메시지 출력
 * - 실제 LED 깜빡임 확인
 *
 * 하드웨어: XIAO ESP32-C6
 * 프로세서: 듀얼 RISC-V (160MHz HP + 20MHz LP)
 * 메모리: 512KB SRAM + 4MB Flash
 */

// XIAO ESP32-C6 내장 LED 핀 정의
#define USER_LED 15
...
void setup() {
  ...
  // 시작 메시지
  Serial.println("\n========================================");
  Serial.println("XIAO ESP32-C6 블링크 테스트 시작!");
  Serial.println("========================================");
